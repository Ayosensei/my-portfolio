...
const projects = [
    {
        ...
        description: "A futuristic shopping experience built with Next.js and Stripe. Features real-time inventory and dark mode UI.",
    ...
    {
        title: "Abstract Dashboard",
        description: "Data visualization platform using D3.js. Converts complex datasets into interactive abstract art forms.",
